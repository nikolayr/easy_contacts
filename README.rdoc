...
2do
 add activity records for contact creation (acts_as_activity_provider)
 ...
 add permissions to view and creating contacts entries 
 checm entries creation for new nonAdmin user
 set proper access right for attach view and delete (see attachments_visible? attachments_deletable? in easycontact )

 ?add project id to contacts, sort out by projectid when showing all contacts
